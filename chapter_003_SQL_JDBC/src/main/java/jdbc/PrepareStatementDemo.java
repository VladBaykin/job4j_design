...
public class PrepareStatementDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(demo.insert(new City(1, "Moscow", 12)));
        demo.update(new City(1, "Tokyo", 9));
        demo.findAll().forEach(System.out::println);
        demo.delete(1);
        System.out.println(demo.findAll().size());
    }
}
